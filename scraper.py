#!/usr/bin/env python3
"""
Vita ⴾ — منشئ ملفات المشروع الحيوي
=====================================
هذا السكريبت ينشئ هيكل مشروع فيتا بالكامل تلقائيًا.
ما عليك سوى تشغيله، وسيقوم بإنشاء جميع الملفات والمجلدات.
...
def get_index_html():
    """الصفحة الرئيسية — المحفظة البيولوجية"""
    return '''<!DOCTYPE html>
...
<body>
        ...
        <div class="card" id="walletCard">
            ...
            <div class="info-line">
                <div class="info-item">
                    ...
                    <div class="value" id="freqDisplay"># 7.83 Hz / ID: 4401</div>
                </div>
                <div class="info-item">
    ...
    <div id="fingerprintOverlay" class="fingerprint-overlay" style="display: none;">
        <div class="fingerprint-scanner" id="fingerScanner" onclick="simulateFingerprint()"><i class="fas fa-fingerprint"></i></div>
        <p class="fingerprint-text" id="fingerText">المس الدائرة لمحاكاة البصمة</p>
    </div>
...
<input type="text" placeholder="التردد البيولوجي أو البريد الحيوي">
<br>
